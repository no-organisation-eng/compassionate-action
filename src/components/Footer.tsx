  ...
  <footer className="gradient-navy text-gold-light/80">
    ...
    <div className="container mx-auto px-4 py-10 grid md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <div className="flex flex-col gap-2 text-sm">
          <span className="flex items-center gap-2"><Mail size={14} /> worldenlightenorganization@gmail.com</span>
          <span className="flex items-center gap-2"><Phone size={14} /> +234 813 541 7227</span>
          <span className="flex items-center gap-2"><MapPin size={14} /> 7 Diamond Hill, Calabar</span>
          <a href="https://www.facebook.com/profile.php?id=100066570099602" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-gold transition-colors">
    ...
    <div className="border-t border-gold/10 text-center py-4 text-xs text-gold-light/50">
      <p className="flex items-center justify-center gap-1">
        © {new Date().getFullYear()} Enlighten Community. Made with <Heart size={12} className="text-gold" /> Est. 2003
      </p>
    </div>
  </footer>
);
