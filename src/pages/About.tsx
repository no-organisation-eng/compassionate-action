  ...
  <div className="pt-16">
    ...
    <section className="gradient-navy text-gold-light py-20">
      <div className="container mx-auto px-4 text-center">
        <img src={logo} alt="Enlighten Community" className="w-28 h-28 rounded-full mx-auto mb-6 border-4 border-gold/30 object-cover" />
    ...
    <section className="py-16 bg-muted/30">
      <div className="container mx-auto px-4 max-w-3xl">
        <SectionHeading title="Who We Are" subtitle="Enlighten Community (World Enlighten Organization aka Enlighten Health and Leadership Humanitarian Foundation) is a non-governmental organization established in 2003, committed to transforming lives through compassion, education, and community-driven action." />
