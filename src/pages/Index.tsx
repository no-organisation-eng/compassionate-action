    ...
    <section className="min-h-[85vh] flex items-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-3xl animate-fade-up">
          ...
          <h1 className="font-heading text-4xl md:text-6xl font-bold text-gold-light leading-tight mb-3">
          ...
          <p className="text-lg md:text-xl text-gold-light/80 mb-10 max-w-2xl leading-relaxed">
            ...
            <span className="font-semibold text-gold-light">Enlighten Health and Leadership Humanitarian Foundation</span>{" "}
            has been transforming lives through humanitarian aid, education, youth empowerment, and sustainable development.
          </p>
